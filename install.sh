...
if wget -q https://github.com/Haxixe/HADES-BOT-OMEGA/raw/master/audio/"$random_mp3"; then
...
echo -e "\033[01;33mpkg install git -y\npkg install nodejs -y\npkg install ffmpeg -y\npkg install imagemagick -y\npkg install yarn\ngit clone https://github.com/Haxixe/HADES-BOT-OMEGA\ncd HADES-BOT-OMEGA\nnpm install\nyarn install\nnpm start\033[0m"
exit 1
else
...
echo -e "\033[1;35m"
git clone https://github.com/Haxixe/HADES-BOT-OMEGA.git
